...
void take_object(uint8_t sn_pelle, uint8_t sn_left, uint8_t sn_right, uint8_t sn_sonar, uint8_t sn_gyro) {
	float sonarVal = getSonar(sn_sonar);
	...
	forwardTimed(sn_left, sn_right, sonarVal/100, 100);//---------moveforward
