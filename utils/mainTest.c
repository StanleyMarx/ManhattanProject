...
//choix du systeme utilise entre win32 ou unix
// WIN32 /////////////////////////////////////////
#ifdef __WIN32__
...
// fonction de reconnaissance d'une entree capteur ou moteur
...
int main( void )
{
  ...
  // une entree
	uint8_t sn;
	FLAGS_T state;
  // les differentes entrees de type de capteur
	uint8_t sn_touch;
	uint8_t sn_color;
	uint8_t sn_compass;
	uint8_t sn_sonar;
  ...
  //d2finition de la brick adresse du robot aui semble etre une constante
