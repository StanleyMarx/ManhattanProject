/*
  basé sur https://gitlab.eurecom.fr/ludovic.apvrille/OS_Robot_Project_Fall2017/blob/master/client/robotclient.c
  programme pour tester la communication client/serveur coté client
  le bon fonctionnement de ce programme necessite un setup du serveur et du client, cf les liens suivants
    courte doc interne:
      https://github.com/StanleyMarx/ManhattanProject/blob/master/infos/client-server.md
    longue doc du prof:
      https://gitlab.eurecom.fr/ludovic.apvrille/OS_Robot_Project_Fall2017/blob/master/README.md
  ce programme:
    1. se connecte au serveur
    2. attends le START du serveur
    3. envoie 30 messages de position ainsi que des messages d'obstacle
    4. envoie une map inventée avec un obstacle rouge et un obstacle vert
    5. attends le STOP du serveur
*/
